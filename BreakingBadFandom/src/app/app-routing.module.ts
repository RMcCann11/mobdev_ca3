...
const routes: Routes = [
  ...
  {
    path: 'quotes-by-character',
    loadChildren: () => import('./pages/quotes-by-character/quotes-by-character.module').then( m => m.QuotesByCharacterPageModule)
  },
  {
    path: 'death-count',
  ...
  {
    path: 'death-count-by-character',
    loadChildren: () => import('./pages/death-count-by-character/death-count-by-character.module').then( m => m.DeathCountByCharacterPageModule)
  },
  {
    path: 'deaths',
